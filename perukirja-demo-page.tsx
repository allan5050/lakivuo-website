              ...
              <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8">
                <div className="bg-gray-900 rounded-lg border border-gray-800 overflow-hidden">
                  <div className="p-6 bg-gray-800">
                    <h4 className="text-xl font-semibold mb-2">Perusversio</h4>
                    <p className="text-gray-400">Aloita helposti ja näe tulokset</p>
                  </div>
                  
                  <div className="p-6">
                    <p className="text-3xl font-bold mb-4">99€<span className="text-sm text-gray-400">/kk</span></p>
                    
                    <ul className="space-y-3 mb-6">
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-500 mr-2" />
                        <span>Widget verkkosivullesi</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-500 mr-2" />
                        <span>Kalenteriintegraatio</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-500 mr-2" />
                        <span>Dokumenttien lataus</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-500 mr-2" />
                ...
                <div className="bg-blue-900 rounded-lg border border-blue-600 overflow-hidden transform scale-105 shadow-lg">
                  <div className="p-6 bg-blue-800">
                    <div className="flex justify-between items-center mb-2">
                      <h4 className="text-xl font-semibold">Ammattilaisversio</h4>
                      <span className="px-2 py-1 bg-blue-600 text-xs rounded">Suosituin</span>
                    </div>
                    <p className="text-blue-200">Kattava ratkaisu toimistolle</p>
                  </div>
                  
                  <div className="p-6">
                    <p className="text-3xl font-bold mb-4">199€<span className="text-sm text-blue-300">/kk</span></p>
                    
                    <ul className="space-y-3 mb-6">
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-400 mr-2" />
                        <span>Kaikki perusversion ominaisuudet</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-400 mr-2" />
                      ...
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-400 mr-2" />
                        <span>Automaattiset muistutukset</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-400 mr-2" />
                        <span>Tekoälyavusteinen luokittelu</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-400 mr-2" />
                        <span>Oma brändäys</span>
                      </li>
                    </ul>
                    
                    <button className="w-full py-2 bg-white text-blue-900 font-semibold rounded-lg">
                      Tilaa nyt
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-gray-900 rounded-lg border border-gray-800 overflow-hidden">
                  <div className="p-6 bg-gray-800">
                    <h4 className="text-xl font-semibold mb-2">Yrityspaketti</h4>
                    <p className="text-gray-400">Useamman toimipisteen ratkaisu</p>
                  </div>
                  
                  <div className="p-6">
                    <p className="text-3xl font-bold mb-4">Ota yhteyttä</p>
                    
                    <ul className="space-y-3 mb-6">
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-500 mr-2" />
                        <span>Kaikki ammattilaisominaisuudet</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-500 mr-2" />
                        <span>API-integraatiot</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-500 mr-2" />
                        <span>Useiden toimipisteiden hallinta</span>
                      </li>
                      <li className="flex items-center">
                        <Check className="h-5 w-5 text-green-500 mr-2" />
                        <span>24/7 tuki</span>
                    ...
                    <button className="w-full py-2 bg-gray-800 text-white rounded-lg border border-gray-700">
                      Pyydä tarjous
                    </button>
                  </div>
                </div>
