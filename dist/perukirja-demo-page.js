    ...
    return (React.createElement("section", { className: "widget-demo py-16" },
        React.createElement("div", { className: "section-container" },
            ...
            activeSection === 'benefits' && (React.createElement("div", null,
                ...
                React.createElement("div", { className: "py-12" },
                    React.createElement("div", { className: "max-w-4xl mx-auto grid md:grid-cols-3 gap-8" },
                        React.createElement("div", { className: "bg-gray-900 rounded-lg border border-gray-800 overflow-hidden" },
                            React.createElement("div", { className: "p-6 bg-gray-800" },
                                React.createElement("h4", { className: "text-xl font-semibold mb-2" }, "Perusversio"),
                                React.createElement("p", { className: "text-gray-400" }, "Aloita helposti ja n\u00E4e tulokset")),
                            React.createElement("div", { className: "p-6" },
                                React.createElement("p", { className: "text-3xl font-bold mb-4" },
                                    "99\u20AC",
                                    React.createElement("span", { className: "text-sm text-gray-400" }, "/kk")),
                                React.createElement("ul", { className: "space-y-3 mb-6" },
                                    React.createElement("li", { className: "flex items-center" },
                                        ...
                                        React.createElement("span", null, "Widget verkkosivullesi")),
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-500 mr-2" }),
                                        React.createElement("span", null, "Kalenteriintegraatio")),
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-500 mr-2" }),
                                        React.createElement("span", null, "Dokumenttien lataus")),
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-500 mr-2" }),
                                        React.createElement("span", null, "S\u00E4hk\u00F6posti-ilmoitukset"))),
                                React.createElement("button", { className: "w-full py-2 bg-blue-600 text-white rounded-lg" }, "Tilaa nyt"))),
                        React.createElement("div", { className: "bg-blue-900 rounded-lg border border-blue-600 overflow-hidden transform scale-105 shadow-lg" },
                            React.createElement("div", { className: "p-6 bg-blue-800" },
                                React.createElement("div", { className: "flex justify-between items-center mb-2" },
                                    React.createElement("h4", { className: "text-xl font-semibold" }, "Ammattilaisversio"),
                                    React.createElement("span", { className: "px-2 py-1 bg-blue-600 text-xs rounded" }, "Suosituin")),
                                React.createElement("p", { className: "text-blue-200" }, "Kattava ratkaisu toimistolle")),
                            React.createElement("div", { className: "p-6" },
                                React.createElement("p", { className: "text-3xl font-bold mb-4" },
                                    "199\u20AC",
                                    React.createElement("span", { className: "text-sm text-blue-300" }, "/kk")),
                                React.createElement("ul", { className: "space-y-3 mb-6" },
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-400 mr-2" }),
                                        React.createElement("span", null, "Kaikki perusversion ominaisuudet")),
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-400 mr-2" }),
                                        React.createElement("span", null, "Asiakasportaali")),
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-400 mr-2" }),
                                        React.createElement("span", null, "Automaattiset muistutukset")),
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-400 mr-2" }),
                                        React.createElement("span", null, "Teko\u00E4lyavusteinen luokittelu")),
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-400 mr-2" }),
                                        React.createElement("span", null, "Oma br\u00E4nd\u00E4ys"))),
                                React.createElement("button", { className: "w-full py-2 bg-white text-blue-900 font-semibold rounded-lg" }, "Tilaa nyt"))),
                        React.createElement("div", { className: "bg-gray-900 rounded-lg border border-gray-800 overflow-hidden" },
                            React.createElement("div", { className: "p-6 bg-gray-800" },
                                React.createElement("h4", { className: "text-xl font-semibold mb-2" }, "Yrityspaketti"),
                                React.createElement("p", { className: "text-gray-400" }, "Useamman toimipisteen ratkaisu")),
                            React.createElement("div", { className: "p-6" },
                                React.createElement("p", { className: "text-3xl font-bold mb-4" }, "Ota yhteytt\u00E4"),
                                React.createElement("ul", { className: "space-y-3 mb-6" },
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-500 mr-2" }),
                                        React.createElement("span", null, "Kaikki ammattilaisominaisuudet")),
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-500 mr-2" }),
                                        React.createElement("span", null, "API-integraatiot")),
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-500 mr-2" }),
                                        React.createElement("span", null, "Useiden toimipisteiden hallinta")),
                                    React.createElement("li", { className: "flex items-center" },
                                        React.createElement(Check, { className: "h-5 w-5 text-green-500 mr-2" }),
                                        React.createElement("span", null, "24/7 tuki"))),
                                React.createElement("button", { className: "w-full py-2 bg-gray-800 text-white rounded-lg border border-gray-700" }, "Pyyd\u00E4 tarjous")))))))),
